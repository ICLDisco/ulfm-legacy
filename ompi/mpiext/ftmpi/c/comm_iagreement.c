...
#pragma weak OMPI_Comm_iagreement = POMPI_Comm_iagreement
#endif
...
static const char FUNC_NAME[] = "OMPI_Comm_iagreement";


int OMPI_Comm_iagreement(MPI_Comm comm, int *flag, MPI_Request *request)
{
    int rc = MPI_SUCCESS;
