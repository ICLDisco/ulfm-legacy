 ...
 */
int
mca_coll_ftbasic_alltoallw_intra(void *sbuf, int *scounts, int *sdisps,
                               ...
                               mca_coll_base_module_t *module)
{
    ...
    for (i = 0; i < size; ++i) {
        ...
        ++nreqs;
        if (MPI_SUCCESS != err) {
            mca_coll_ftbasic_free_reqs(basic_module->mccb_reqs,
                                     nreqs);
            return err;
        }
    }
    ...
    mca_coll_ftbasic_free_reqs(basic_module->mccb_reqs, nreqs);
 ...
 */
int
mca_coll_ftbasic_alltoallw_inter(void *sbuf, int *scounts, int *sdisps,
                               struct ompi_datatype_t **sdtypes,
                               void *rbuf, int *rcounts, int *rdisps,
                               struct ompi_datatype_t **rdtypes,
                               struct ompi_communicator_t *comm,
