 ...
 */
int
mca_coll_ftbasic_barrier_intra_lin(struct ompi_communicator_t *comm,
 ...
 */
int
mca_coll_ftbasic_barrier_intra_log(struct ompi_communicator_t *comm,
                                 mca_coll_base_module_t *module)
{
    int i;
    int err;
 ...
 */
int
mca_coll_ftbasic_barrier_inter_lin(struct ompi_communicator_t *comm,
                                 mca_coll_base_module_t *module)
{
    int rank;
    int result;
