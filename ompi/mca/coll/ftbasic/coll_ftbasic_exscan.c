 ...
 */
int
mca_coll_ftbasic_exscan_intra(void *sbuf, void *rbuf, int count,
                            ...
                            mca_coll_base_module_t *module)
{
     ...
     * for malloc'ing this size is provided in coll_ftbasic_reduce.c. */
 ...
 */
int
mca_coll_ftbasic_exscan_inter(void *sbuf, void *rbuf, int count,
                            struct ompi_datatype_t *dtype,
                            struct ompi_op_t *op,
                            struct ompi_communicator_t *comm,
                            mca_coll_base_module_t *module)
