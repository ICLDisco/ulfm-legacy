 ...
 */
int
mca_coll_ftbasic_reduce_lin_intra(void *sbuf, void *rbuf, int count,
 ...
 */
int
mca_coll_ftbasic_reduce_log_intra(void *sbuf, void *rbuf, int count,
                                struct ompi_datatype_t *dtype,
                                struct ompi_op_t *op,
                                int root, struct ompi_communicator_t *comm,
                                mca_coll_base_module_t *module)
{
    ...
    if (!ompi_op_is_commute(op)) {
        return mca_coll_ftbasic_reduce_lin_intra(sbuf, rbuf, count, dtype,
                                               op, root, comm, module);
    }
 ...
 */
int
mca_coll_ftbasic_reduce_lin_inter(void *sbuf, void *rbuf, int count,
                                struct ompi_datatype_t *dtype,
                                struct ompi_op_t *op,
                                int root, struct ompi_communicator_t *comm,
                                mca_coll_base_module_t *module)
 ...
 */
int
mca_coll_ftbasic_reduce_log_inter(void *sbuf, void *rbuf, int count,
                                struct ompi_datatype_t *dtype,
                                struct ompi_op_t *op,
                                int root, struct ompi_communicator_t *comm,
                                mca_coll_base_module_t *module)
